...
public class FileTreeContextAdvisor implements StreamAdvisor {
    ...
    @Override
    public int getOrder() {
        return Ordered.HIGHEST_PRECEDENCE; // was: return 0;
    }
}


//llm caching
//prompt 1: You are a robot,you know A,B,C.Now do this:Do my dishes
//prompt 2: You are a robot,you know A,B,C.Now do this:Sing a song
//this same prefix will use cached message


//system prompt:You are a robot,you know A,B,C.Now do this:
//+FileTree
//user prompt: do my dishes
