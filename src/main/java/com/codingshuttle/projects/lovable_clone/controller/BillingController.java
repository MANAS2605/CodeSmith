...
public class BillingController {
    ...
    public ResponseEntity<String> handlePaymentWebhooks(
        ...
        try {
            Event event= Webhook.constructEvent(payload,sigHeader,webhookSecret);//all the events occuring in the stripe portal will now be connected to our backend via webhook
