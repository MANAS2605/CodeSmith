...
export function CodePanel({ projectId, updatedFiles }: CodePanelProps) {
  ...
  return (
    <div className="flex h-full bg-background text-foreground overflow-hidden">
      {/* 240px File Tree Column */}
      <div className="w-[240px] shrink-0 border-r border-border overflow-y-auto bg-panel flex flex-col">
        <div className="h-9 px-3 border-b border-border flex items-center shrink-0">
          <span className="font-mono text-[11px] uppercase tracking-wider text-muted-foreground font-medium select-none">
            Files
          </span>
        </div>
