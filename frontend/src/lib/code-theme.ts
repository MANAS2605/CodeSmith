...
const darkSettings = { background: "#0B071E", backgroundImage: "", foreground: "#e2e8f0", caret: "#06B6D4", selection: "#2D1B4E", selectionMatch: "#3b2368", lineHighlight: "#2D1B4E33", gutterBackground: "#0B071E", gutterForeground: "#6D28D9", gutterBorder: "transparent" };
