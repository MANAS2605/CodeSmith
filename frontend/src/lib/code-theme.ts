...
const darkSettings = { background: "#080c1e", backgroundImage: "", foreground: "#e2e8f0", caret: "#38bdf8", selection: "#2e3856", selectionMatch: "#3b4668", lineHighlight: "#1e293b33", gutterBackground: "#080c1e", gutterForeground: "#64748b", gutterBorder: "transparent" };
